 ...
 */
public class KCssInliner {
	private static Logger logger = Logger.getLogger(KCssInliner.class);
	 ...
	 * @param doc the html document
	 */
	private static void extractStyles(Document doc) {
		...
		logger.debug("trimmedStylesheet:\n" + trimmedStylesheet);

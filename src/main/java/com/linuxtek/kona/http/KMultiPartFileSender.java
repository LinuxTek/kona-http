 ...
 */
public class KMultiPartFileSender {
	protected final static Logger logger = LoggerFactory.getLogger(KMultiPartFileSender.class);
	...
	public static KMultiPartFileSender fromBytes(byte[] data) {
		return KMultiPartFileSender.fromBytes(data, null);
	}
	...
	public static KMultiPartFileSender fromBytes(byte[] data, String contentType, String fileName) {
		...
		try {
            ...
            logger.error("Error creating temp file from data", e);
		}
	...
	public static KMultiPartFileSender fromPath(Path path) {
		return new KMultiPartFileSender().setFilepath(path);
	}

	public static KMultiPartFileSender fromFile(File file) {
		return new KMultiPartFileSender().setFilepath(file.toPath());
	}

	public static KMultiPartFileSender fromURIString(String uri) {
		return new KMultiPartFileSender().setFilepath(Paths.get(uri));
	}

	public KMultiPartFileSender withRequest(HttpServletRequest httpRequest) {
		this.request = httpRequest;
		return this;
	}
    
	public KMultiPartFileSender withResponse(HttpServletResponse httpResponse) {
		this.response = httpResponse;
		return this;
	}
    
	public KMultiPartFileSender withContentType(String contentType) {
	...
	public KMultiPartFileSender withDispositionAttachment() {
		forceDisposition(CONTENT_DISPOSITION_ATTACHMENT);
		return this;
	}
    
	public KMultiPartFileSender withNoDisposition() {
		forceDisposition(null);
		return this;
	}
    
	//** internal setter **//
	private KMultiPartFileSender setFilepath(Path filepath) {
		this.filepath = filepath;
		return this;
	}
	
	private KMultiPartFileSender setTempFile(File tempFile) {
	...
	public void serveResource() throws Exception {
		...
		if (contentType == null) {
			contentType = KMimeTypes.probeContentType(filepath);
		}
